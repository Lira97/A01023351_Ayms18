...
public:
	void sendMail(){
		cout <<"MAIL:" << endl <<"From: 123@gmail.com"<<endl<<"to: "<<mail[i] <<endl<<  "Message: Nuevo servicio." << endl << endl;
		}
	void sendSms(){
		cout <<"SMS:" << endl <<"to: "<<phone[i] <<endl<<  "Message: Nuevo servicio." << endl << endl;
		}
	void phoneCall(){
		cout <<"LLamada"<<endl<<"to: "<<phone[i] <<"."<< endl << endl;
		}
};
